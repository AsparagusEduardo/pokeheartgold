...
static const u8 sSafariZoneDefaultAreaSets[10][SAFARI_ZONE_MAX_AREAS_PER_SET] = {
    { SAFARI_ZONE_AREA_PLAINS,    SAFARI_ZONE_AREA_SWAMP,     SAFARI_ZONE_AREA_MEADOW,    SAFARI_ZONE_AREA_WETLAND,   SAFARI_ZONE_AREA_PEAK, SAFARI_ZONE_AREA_FOREST    },
    { SAFARI_ZONE_AREA_MEADOW,    SAFARI_ZONE_AREA_MARSHLAND, SAFARI_ZONE_AREA_WETLAND,   SAFARI_ZONE_AREA_FOREST,    SAFARI_ZONE_AREA_PEAK, SAFARI_ZONE_AREA_SWAMP     },
    { SAFARI_ZONE_AREA_WETLAND,   SAFARI_ZONE_AREA_WASTELAND, SAFARI_ZONE_AREA_FOREST,    SAFARI_ZONE_AREA_SWAMP,     SAFARI_ZONE_AREA_PEAK, SAFARI_ZONE_AREA_MARSHLAND },
    { SAFARI_ZONE_AREA_FOREST,    SAFARI_ZONE_AREA_MOUNTAIN,  SAFARI_ZONE_AREA_SWAMP,     SAFARI_ZONE_AREA_MARSHLAND, SAFARI_ZONE_AREA_PEAK, SAFARI_ZONE_AREA_WASTELAND },
    { SAFARI_ZONE_AREA_SWAMP,     SAFARI_ZONE_AREA_SAVANNAH,  SAFARI_ZONE_AREA_MARSHLAND, SAFARI_ZONE_AREA_WASTELAND, SAFARI_ZONE_AREA_PEAK, SAFARI_ZONE_AREA_MOUNTAIN  },
    { SAFARI_ZONE_AREA_MARSHLAND, SAFARI_ZONE_AREA_PLAINS,    SAFARI_ZONE_AREA_WASTELAND, SAFARI_ZONE_AREA_MOUNTAIN,  SAFARI_ZONE_AREA_PEAK, SAFARI_ZONE_AREA_SAVANNAH  },
    { SAFARI_ZONE_AREA_WASTELAND, SAFARI_ZONE_AREA_MEADOW,    SAFARI_ZONE_AREA_MOUNTAIN,  SAFARI_ZONE_AREA_SAVANNAH,  SAFARI_ZONE_AREA_PEAK, SAFARI_ZONE_AREA_PLAINS    },
    { SAFARI_ZONE_AREA_MOUNTAIN,  SAFARI_ZONE_AREA_WETLAND,   SAFARI_ZONE_AREA_SAVANNAH,  SAFARI_ZONE_AREA_PLAINS,    SAFARI_ZONE_AREA_PEAK, SAFARI_ZONE_AREA_MEADOW    },
    { SAFARI_ZONE_AREA_SAVANNAH,  SAFARI_ZONE_AREA_FOREST,    SAFARI_ZONE_AREA_PLAINS,    SAFARI_ZONE_AREA_MEADOW,    SAFARI_ZONE_AREA_PEAK, SAFARI_ZONE_AREA_WETLAND   },
    { SAFARI_ZONE_AREA_PLAINS,    SAFARI_ZONE_AREA_SAVANNAH,  SAFARI_ZONE_AREA_WETLAND,   SAFARI_ZONE_AREA_SWAMP,     SAFARI_ZONE_AREA_PEAK, SAFARI_ZONE_AREA_WASTELAND },
};
